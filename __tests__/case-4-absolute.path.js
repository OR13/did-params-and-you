...
it("case 4", async () => {
  const vc = await vcjs.issue({
    credential: {
      ...
      issuer: {
        id: "did:example:123/version/77d66171-b290-489c-abf1-95ae10725201",
      },
    ...
    suite: new Ed25519Signature2018({
      key: await Ed25519KeyPair.from({
        ...
        // in this case, the credential is issued from a specific version of a did document
        // which contains a specific key.
        id:
          "did:example:123/version/77d66171-b290-489c-abf1-95ae10725201#credential-issuance-key",
        type: "Ed25519VerificationKey2018",
        controller:
          "did:example:123/version/77d66171-b290-489c-abf1-95ae10725201",
    ...
    documentLoader: (uri) => {
      if (
        ...
        const didDocument = {
          ...
          // this is not legal according to did core
          // but required to verify a credential with a path paramater in the verificationMethod.
          id: "did:example:123/version/77d66171-b290-489c-abf1-95ae10725201",
          assertionMethod: [
            {
              id:
  ...
  require("fs").writeFileSync(
    require("path").resolve(
      __dirname,
      "../examples/case-4-illegal-working.json"
    ),
